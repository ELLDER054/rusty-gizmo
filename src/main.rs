...
fn compile(code: String) -> String {
    ...
    let sym_table = SymbolController {current: Scope {parent: None, children: Vec::new(), var_symbols: Vec::new(), func_symbols: Vec::new(), struct_symbols: Vec::new(), array_symbols: Vec::new()}};
    let mut parser: Parser = Parser {pos: 0, tokens: tokens, symtable: sym_table, id_c: 0, in_if: false, in_function: false, function_typ: "".to_string(), in_loop: false, label_num: 0, loop_begin: 0, loop_end: 0, array_num: 0};
